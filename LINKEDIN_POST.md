...
- A reproducible Python data pipeline for 2,500 customers and 12,000 orders
- SQL analysis across 75 beginner, intermediate, and advanced business questions
...
- Delayed first orders were strongly linked with customer churn
- Cash on Delivery created a major return and logistics cost challenge
- Champion customers drove a large share of net profit
- Courier performance had a direct impact on satisfaction and retention
- Forecasting can help leadership plan better for seasonal peaks like Eid and 11.11
...
#DataAnalytics #Python #SQL #PowerBI #MachineLearning #BusinessIntelligence #DataScience #PortfolioProject #EcommerceAnalytics
